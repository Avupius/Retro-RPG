...
class Slime(Enemy):
    def __init__(self, pos):
        super().__init__(pos, "assets/Tileset/Cute_Fantasy/Enemies/Slime/Slime_Big/Slime_Big_Green.png", frame_width=64, frame_height=64, frames_per_row=8, speed=50, movebox_inset=(16,16))
...
class Skeleton(Enemy):
    def __init__(self, pos):
        super().__init__(pos,  "assets/Tileset/Cute_Fantasy/Enemies/Skeleton/Skeleton.png", frame_width=32, frame_height=32, frames_per_row=6, speed=50)
